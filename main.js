        ...
        data.results.forEach(function(user) {
            ...
            $('#myModal').find('.modal-content').html(`
                ...
                <div class="modal-body">
                    ...
                    <p><span>Living:</span><a class="my-link" href="https://maps.google.com/?q= ${user.location.city} ${user.location.street.name}"> ${user.location.postcode}, ${user.location.street.name} ${user.location.street.number}, ${user.location.city}, ${user.location.state}, ${user.location.country} (${user.nat})</a></p>
                    <p><span>Current location:</span><iframe class="map" src="https://maps.google.com/maps?q=${user.location.coordinates.latitude},${user.location.coordinates.longitude}&hl=en&z=6&amp;output=embed" frameborder="0" allowfullscreen></iframe>
